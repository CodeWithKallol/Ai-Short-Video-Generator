...
function SelectTopic({onUserSelect}) {
    const options = ['Custom Prompt', 'Random AI Story', 'Scary Story', 'Motivational', 'Bed Time Story', 'Fun Fact', 'Hisstorical Facts'];
    const [selectedOption, setSelectedOption] = useState();
  return (
    <div>
        <h2 className='font-bold text-2xl text-indigo-700'>Content</h2>
